...
export default function ServicesGrid() {
  return (
    <section id="services" className="bg-surface-mint">
      <SectionBackdrop>
        <div className="mx-auto max-w-container px-6 py-20">
          <div className="mx-auto mb-10 flex max-w-[620px] flex-col items-center gap-3.5 text-center">
            ...
            <h2 className="text-[clamp(1.75rem,4.5vw,2.375rem)] font-extrabold tracking-tight text-ink">Nos services</h2>
            ...
            {services.map((s) => {
              ...
              return (
                <RevealOnScroll key={s.title}>
                  <div className="group flex h-full flex-col gap-4 overflow-hidden rounded-2xl border-[0.5px] border-hairline bg-white px-7 py-8 transition-all duration-[180ms] hover:-translate-y-1 hover:shadow-[0_16px_32px_rgba(31,138,59,.14)]">
                    <div
                      className="flex h-14 w-14 items-center justify-center rounded-2xl shadow-[0_3px_8px_rgba(31,138,59,.3)] transition-transform duration-200 group-hover:scale-110"
                      style={{ background: 'linear-gradient(135deg, #22913E, #0F5A2B)' }}
                    >
          ...
          <RevealOnScroll className="mx-auto mt-14 max-w-[880px]">
            <div className="overflow-hidden rounded-2xl border-[0.5px] border-hairline bg-white shadow-[0_10px_30px_rgba(31,138,59,.08)]">
              <CompanyVideo />
