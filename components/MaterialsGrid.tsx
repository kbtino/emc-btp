...
export default function MaterialsGrid() {
  return (
    <section id="materiaux" className="bg-white">
      <div className="mx-auto max-w-container px-6 py-24">
        <div className="mx-auto mb-14 flex max-w-[620px] flex-col gap-3.5 text-center">
          <div className="text-[12.5px] font-bold uppercase tracking-[1.5px] text-brand">Catalogue</div>
          <h2 className="text-[38px] font-extrabold tracking-tight text-ink">Nos matériaux</h2>
        ...
        <div className="grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-7">
          {materials.map((m, i) => (
            <RevealOnScroll key={m.name + i}>
              <div className="flex h-full flex-col overflow-hidden rounded-xl border-[0.5px] border-hairline bg-white transition-all duration-[180ms] hover:-translate-y-1 hover:shadow-[0_12px_28px_rgba(15,110,86,.14)]">
        ...
        <div className="mt-12 text-center">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-[10px] bg-brand px-[30px] py-[15px] text-[16px] font-bold text-white shadow-[0_3px_8px_rgba(15,110,86,.3)] transition-all duration-150 hover:scale-[1.02] hover:bg-brand-dark"
          >
            <IconTag size={19} />
            Demander les tarifs
          </a>
