          ...
          <div className="grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-7">
            {materials.map((m, i) => (
              <RevealOnScroll key={m.name + i}>
                <div className="group flex h-full flex-col overflow-hidden rounded-xl border-[0.5px] border-hairline bg-white transition-all duration-[180ms] hover:-translate-y-1 hover:shadow-[0_16px_32px_rgba(15,110,86,.16)]">
                  <div
